...
impl Theme {
    pub fn from_settings(settings: &Settings) -> Self {
        ...
        Theme {
            ...
            gutter: color_to_hsla(t.gutter),
            status_bar: color_to_hsla(t.status_bar),
            ...
            syn_variable_def: color_to_hsla(s.variable_def),
            ...
            syn_string: color_to_hsla(s.string),
